                ...
                <ul className="goods__list slider__list">
                  <li className="goods__item slider__item">
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-1@1x.webp 1x, img/product-photo-1@2x.webp 2x"
                          />
                          <img
                    ...
                    C/O https://placeholder.com/"
                            ...
                            srcSet="img/product-photo-1@1x.jpg 1x, img/product-photo-1@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                    ...
                    <a className="product product--sale" href="#">
                      ...
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-2@1x.webp 1x, img/product-photo-2@2x.webp 2x"
                          />

                          <img
                            src="img/product-photo-2@1x.jpg"
                            width="214"
                            height="248"
                            alt="Мягкое кресло Манн-Уитни"
                            srcSet="img/product-photo-2@1x.jpg 1x, img/product-photo-2@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-3@1x.webp 1x, img/product-photo-3@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-3@1x.jpg"
                            width="214"
                            height="248"
                            alt="Кожаный диван Колумб"
                            srcSet="img/product-photo-3@1x.jpg 1x, img/product-photo-3@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-4@1x.webp 1x, img/product-photo-4@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-4@1x.jpg"
                            width="214"
                            height="248"
                            alt="Диван Рэдмен"
                            srcSet="img/product-photo-4@1x.jpg 1x, img/product-photo-4@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-5@1x.webp 1x, img/product-photo-5@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-5@1x.jpg"
                            width="214"
                            height="248"
                            alt="Прикроватный столик Пьер"
                            srcSet="img/product-photo-5@1x.jpg 1x, img/product-photo-5@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-6@1x.webp 1x, img/product-photo-6@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-6@1x.jpg"
                            width="214"
                            height="248"
                            alt="Стул Детройт"
                            srcSet="img/product-photo-6@1x.jpg 1x, img/product-photo-6@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-7@1x.webp 1x, img/product-photo-7@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-7@1x.jpg"
                            width="214"
                            height="248"
                            alt="Тканевый диван Альфред"
                            srcSet="img/product-photo-7@1x.jpg 1x, img/product-photo-7@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product product--sale" href="#">
                      ...
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-8@1x.webp 1x, img/product-photo-8@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-8@1x.jpg"
                            width="214"
                            height="248"
                            alt="Обеденный комплект для кухни Модерн"
                            srcSet="img/product-photo-8@1x.jpg 1x, img/product-photo-8@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-9@1x.webp 1x, img/product-photo-9@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-9@1x.jpg"
                            width="214"
                            height="248"
                            alt="Мягкое кресло Фред"
                            srcSet="img/product-photo-9@1x.jpg 1x, img/product-photo-9@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-10@1x.webp 1x, img/product-photo-10@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-10@1x.jpg"
                            width="214"
                            height="248"
                            alt="Медный светильник Конг"
                            srcSet="img/product-photo-10@1x.jpg 1x, img/product-photo-10@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product product--sale" href="#">
                      ...
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-11@1x.webp 1x, img/product-photo-11@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-11@1x.jpg"
                            width="214"
                            height="248"
                            alt="Деревянный табурет Роган"
                            srcSet="img/product-photo-11@1x.jpg 1x, img/product-photo-11@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-12@1x.webp 1x, img/product-photo-12@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-12@1x.jpg"
                            width="214"
                            height="248"
                            alt="Обеденный комплект для кухни Вууд"
                            srcSet="img/product-photo-12@1x.jpg 1x, img/product-photo-12@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-13@1x.webp 1x, img/product-photo-13@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-13@1x.jpg"
                            width="214"
                            height="248"
                            alt="Мягкое кресло Девил"
                            srcSet="img/product-photo-13@1x.jpg 1x, img/product-photo-13@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-14@1x.webp 1x, img/product-photo-14@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-14@1x.jpg"
                            width="214"
                            height="248"
                            alt="Журнальный столик Ален"
                            srcSet="img/product-photo-14@1x.jpg 1x, img/product-photo-14@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-15@1x.webp 1x, img/product-photo-15@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-15@1x.jpg"
                            width="214"
                            height="248"
                            alt="Обеденный комплект для кухни Денвер"
                            srcSet="img/product-photo-15@1x.jpg 1x, img/product-photo-15@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-16@1x.webp 1x, img/product-photo-16@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-16@1x.jpg"
                            width="214"
                            height="248"
                            alt="Мягкое кресло Барби"
                            srcSet="img/product-photo-16@1x.jpg 1x, img/product-photo-16@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-17@1x.webp 1x, img/product-photo-17@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-17@1x.jpg"
                            width="214"
                            height="248"
                            alt="Комплект для веранды Вест"
                            srcSet="img/product-photo-17@1x.jpg 1x, img/product-photo-17@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-18@1x.webp 1x, img/product-photo-18@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-18@1x.jpg"
                            width="214"
                            height="248"
                            alt="Кресло Олдмен"
                            srcSet="img/product-photo-18@1x.jpg 1x, img/product-photo-18@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product product--sale" href="#">
                      ...
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-19@1x.webp 1x, img/product-photo-19@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-19@1x.jpg"
                            width="214"
                            height="248"
                            alt="Детское кресло Манго"
                            srcSet="img/product-photo-19@1x.jpg 1x, img/product-photo-19@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
                    ...
                    <a className="product" href="#">
                      <div className="product__image">
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="img/product-photo-20@1x.webp 1x, img/product-photo-20@2x.webp 2x"
                          />
                          <img
                            src="img/product-photo-20@1x.jpg"
                            width="214"
                            height="248"
                            alt="Деревянный комод Винди"
                            srcSet="img/product-photo-20@1x.jpg 1x, img/product-photo-20@2x.jpg 2x"
                          />
                        </picture>
                      </div>
                      <div className="product__description">
